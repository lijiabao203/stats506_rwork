...
c.  
Although for all genres of sales, prices all have rising trends in these years, we can see in the first plot, thre are lots of green points with higher prices in latter years. And in the latter figure, the mean value can help us to summarize it better. we can see that genres affect the price by rising the amount of high price genres like "Photography".
